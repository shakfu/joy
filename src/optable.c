...
static struct {
    ...
    { Q0, OK, "__COPIED", id_, "->", "no message ever, used for gc." },

    { Q0, OK, "__USR", id_, "->", "user node." },

    { Q0, OK, "__ANON_FUNCT", id_, "->", "op for anonymous function call." },
    ...
    { Q0, OK, " character type", id_, "->  C",
      "The type of characters. Literals are written with a single "
      "quote.\nExamples:  'A  '7  ';  and so on. Unix style escapes are "
      "allowed." },

    { Q0, OK, " integer type", id_, "->  I",
      "The type of negative, zero or positive integers.\nLiterals are written "
      "in decimal notation. Examples:  -123   0   42." },

    { Q0, OK, " set type", id_, "->  {...}",
      "The type of sets of small non-negative integers.\nThe maximum is "
      "platform dependent, typically the range is 0..31.\nLiterals are "
      "written inside curly braces.\nExamples:  {}  {0}  {1 3 5}  {19 18 "
      "17}." },
    ...
    { Q0, OK, " list type", id_, "->  [...]",
      ...
      "type of quoted programs which may contain operators or "
      "combinators.\nLiterals of this type are written inside square "
      "brackets.\nExamples: []  [3 512 -7]  [john mary]  ['A 'C ['B]]  [dup "
      "*]." },

    { Q0, OK, " float type", id_, "->  F",
      "The type of floating-point numbers.\nLiterals of this type are written "
      "with embedded decimal points (like 1.2)\nand optional exponent "
      "specifiers (like 1.5E2)." },

    { Q0, OK, " file type", id_, "->  FILE:",
      "The type of references to open I/O streams,\ntypically but not "
      "necessarily files.\nThe only literals of this type are stdin, stdout, "
      "and stderr." },

    { Q0, OK, " bignum type", id_, "->  F",
      "The type of arbitrary precision floating-point numbers.\nLiterals of "
      "this type are written with embedded decimal points (like 1.2)\nand "
      "optional exponent specifiers (like 1.5E2)." },
...
int tablesize(void) { return sizeof(optable) / sizeof(optable[0]); }
#endif
