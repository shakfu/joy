...
/* Helper macros and function for manual generation */
...
static void make_manual(int style) /* 0=plain, 1=HTML, 2=Latex */
{
    ...
    for (i = BOOLEAN_; i < j; i++) {
        ...
        else HEADER(n, "false", "operand") else HEADER(n, "id", "operator") else HEADER(n, "null", "predicate") else HEADER(
            n,
            "i", "combinator") else HEADER(n, "help",
                                           "miscellaneous "
                                           "commands") else HEADER(n, "assign",
                                                                   "additional"
                                                                   " command"
                                                                   "s") else HEADER(n,
                                                                                    "#genrec",
